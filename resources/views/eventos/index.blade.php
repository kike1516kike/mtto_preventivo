...
@section('content')
    <div class="container">
        ...
        <a href="{{ route('equipos.index') }}" class="btn btn-success">IR A LISTADO DE EQUIPOS</a>
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                ...
                                <button type="button" class="btn btn-danger btn-sm" data-bs-toggle="modal"
                                    data-bs-target="#confirmDeleteModal{{ $evento->id_evento }}">Eliminar</button>
                            </td>
                        </tr>
                    @empty
                        <tr>
    ...
    @foreach ($eventos as $evento)
        <div class="modal fade" id="confirmDeleteModal{{ $evento->id_evento }}" tabindex="-1"
            aria-labelledby="confirmDeleteModalLabel{{ $evento->id_evento }}" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title text-dark" id="confirmDeleteModalLabel{{ $evento->id_evento }}">Eliminar
                            evento</h5>
                    ...
                    <div class="modal-footer">
                        ...
                        <form action="{{ route('eventos.destroy', $evento->id_evento) }}" method="post"
                            id="deleteForm{{ $evento->id_evento }}" class="frmDelete">
                            @csrf
                            @method('DELETE')

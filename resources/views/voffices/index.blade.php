                ...
                @forelse ($voffices as $voffice)
                    <tr>
                        ...
                        <td class="text-center">
                            ...
                            <button type="button" class="btn btn-danger btn-sm" data-bs-toggle="modal" data-bs-target="#confirmDeleteModal{{ $voffice->id_office }}">Eliminar</button>
                        </td>
                    </tr>
                @empty
                    <tr>
        ...
        <div class="col-md-12 d-flex justify-content-center">
            <nav arial-label="Page navegation example">
                <ul class="pagination">
                    ...
                    @foreach ($voffices->getUrlRange(1, $voffices->lastPage()) as $page => $url)
...
<div class="modal fade" id="confirmDeleteModal{{ $voffice->id_office }}" tabindex="-1" aria-labelledby="confirmDeleteModalLabel{{ $voffice->id_office }}" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title text-dark" id="confirmDeleteModalLabel{{ $voffice->id_office }}">Eliminar Office</h5>
            ...
            <div class="modal-footer">
                ...
                <!-- Form for deletion -->
                <form action="{{ route('voffices.destroy', $voffice) }}" method="post" id="deleteForm{{ $voffice->id_office }}" class="frmDelete">
                    @csrf
                    @method('DELETE')

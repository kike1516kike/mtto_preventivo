...
Route::middleware('auth')->group(function () {
    ...
    Route::middleware(['auth', 'role:' . Role::ADMIN])->group(function () {
        ...
        Route::get('/observaciones/{observacion}/view', [ObservacionController::class, 'show'])->name('observaciones.show');
    ...
    Route::middleware(['auth', 'role:' . Role::STANDARD])->group(function () {
        /*RUTAS DE Destinatarios*/
        Route::get('/destinatarios', [DestinatarioController::class, 'index'])->name('destinatarios.index');
        Route::get('/destinatarios/{destinatario}/view', [DestinatarioController::class, 'show'])->name('destinatarios.show');
        Route::put('/destinatarios/{destinatario}/firma_usuario', [DestinatarioController::class, 'firma_usuario'])->name('destinatarios.firma_usuario');
    });
